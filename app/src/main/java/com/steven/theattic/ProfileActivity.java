...
public class ProfileActivity extends AppCompatActivity {
    ...
    private Uri prifileImageUri = null;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        doneBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(name) && prifileImageUri != null){
                    StorageReference profileImagePath = mStorageRef.child("profile_images").child(prifileImageUri.getLastPathSegment());
                    profileImagePath.putFile(prifileImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GALLERY_REQ && resultCode == RESULT_OK){
            prifileImageUri = data.getData();
            imageButton.setImageURI(prifileImageUri);
        }
    }
}
